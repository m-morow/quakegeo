...
## from NSHM23 Fault Section Database (FSD) ##
...
def getDip(slip): #function not used for FSD faults
    """
...
#initialize arrays
#count the number of Value and Type errors
#count should be 0 for FSD
#some count for QFFD, but negligible (<50 / 113,000)
...
with open("/Users/mtan/Library/CloudStorage/OneDrive-DOI/data/Mw6_surfRup_onOffFault/output/FSD/{}.csv".format(project),'a+') as f, open("/Users/mtan/Library/CloudStorage/OneDrive-DOI/data/Mw6_surfRup_onOffFault/output/FSD/{}_buffer.csv".format(project), 'a+') as f2:
    ...
    for idx, feature in enumerate(layer.getFeatures()):
        ...
        dir = feature['DipDir']
        dip = feature['DipDeg']
        faultName = feature['FaultName']
        faultId = feature['FaultID']
        
        #dip = getDip(slip) #not used for FSD
...
df = pd.read_csv('/Users/mtan/Library/CloudStorage/OneDrive-DOI/data/Mw6_surfRup_onOffFault/output/FSD/{}.csv'.format(project), index_col=None)
...
if not df.empty:
    ...
    polygon_gdf.to_file('/Users/mtan/Library/CloudStorage/OneDrive-DOI/data/Mw6_surfRup_onOffFault/output/FSD/{}.shp'.format(project))

#read in dataframe to create buffer polygon
df2 = pd.read_csv('/Users/mtan/Library/CloudStorage/OneDrive-DOI/data/Mw6_surfRup_onOffFault/output/FSD/{}_buffer.csv'.format(project), index_col=None)
...
if not df2.empty:
    ...
    polygon_gdf2.to_file('/Users/mtan/Library/CloudStorage/OneDrive-DOI/data/Mw6_surfRup_onOffFault/output/FSD/{}_buffer.shp'.format(project))

print("Type error counts: ", TEcount)
print("Buffered Value error counts: ", VEvertCount)
print("Non-buffered Value error counts: ", VEcount)
