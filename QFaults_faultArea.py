...
"""
Create shapefiles of fault areas using QFFD
Data from QFFD; usable on HazFaults
"""
...
project = 'onFault_WestUS_Areas'

#create or append to csv files
with open("/Users/mtan/Desktop/{}.csv".format(project),'a+') as f, open("/Users/mtan/Desktop/{}_buffer.csv".format(project), 'a+') as f2, open("/Users/mtan/Desktop/{}_attr.csv".format(project), 'a+') as f3, open("/Users/mtan/Desktop/{}_attr_buffer.csv".format(project), 'a+') as f4:
    fieldnames = ['loc']
    fieldnames2 = ['fid', 'fault_name', 'fault_id', 'dip_direct', 'dip_deg', 'slip_rate', 'slip_sense', 'fault_length']
    ...
    writeHeader3 = csv.DictWriter(f3, fieldnames=fieldnames2)
    writeHeader3.writeheader()
    writer3 = csv.writer(f3)

    writeHeader4 = csv.DictWriter(f4, fieldnames=fieldnames2)
    writeHeader4.writeheader()
    ...
    for idx, feature in enumerate(layer.getFeatures()):
        ...
        if x_shift == 0 and y_shift == 0:
            ...
            try:
                ...
                try:
                    writer2.writerow([xyPoly])

                    attr = [buffCount, faultName, faultId, dir, dip, slipRate, slip, faultLength]
            ...
            try:
                writer.writerow([xyPoly])

                attr = [regCount, faultName, faultId, dir, dip, slipRate, slip, faultLength]
...
df = pd.read_csv('/Users/mtan/Desktop/{}.csv'.format(project), index_col=None)
...
if not df.empty:
    ...
    polygon_gdf.to_file('/Users/mtan/Desktop/{}.shp'.format(project))

#read in dataframe to create buffer polygon
df2 = pd.read_csv('/Users/mtan/Desktop/{}_buffer.csv'.format(project), index_col=None)
...
if not df2.empty:
    ...
    polygon_gdf2 =  gpd.GeoDataFrame(geometry=geom_list_3)

    polygon_gdf2.to_file('/Users/mtan/Desktop/{}_buffer.shp'.format(project))
